...
function GamePage() {
  ...
  const handleSendLink = () => {
    const text = `I scored ${score} points in Cat Game!\nI dare you to challenge me!\nFarm 🍅 COIN with me and secure your token allocation through Tomarket.ai.\nUse my link to get 2,000 🍅 COIN!`
        ...
        <div className='popup-frens'>
          ...
          <div className='content'>
            <div className='content-desc'>
              <div>Get 2000 <img src='/assets/common/coin.png' />and 1 <img src='/assets/common/ticket.png' />（Invite a Friend）</div>
              <div>Get 20000 <img src='/assets/common/coin.png' />and 5 <img src='/assets/common/ticket.png' />（Invite a Telegram Premium）</div>
            </div>
            <div className='popup-content-btn' onClick={() => handleCopyLink()}>Copy link</div>
            <div className='popup-content-btn btn-send' onClick={() => handleSendLink()}>Send</div>
          </div>
