import { getProductListReq, buyProductReq, bindWalletReq, sendOrderProductReq } from '@/api/common';
import './index.scss'
...
function RechargePage() {
  ...
  const sendOrder = async () => {
    ...
    const res = await await sendOrderProductReq({ id: item.id })
  ...
  return <div className='product-page'>
    ...
    <div className='bot-content'>
      ...
      <div className='recharge-btn touch-btn' onClick={() => sendOrder()}>
        <FormattedMessage id='recharge' />
      </div>
    </div>
  </div>
