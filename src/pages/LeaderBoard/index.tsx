...
export default function LeaderBoardPage() {
    ...
    <div className="myself" onClick={() => navigate('/detail?myself=true')}>
      <div className="left">
        ...
        <div className="name-score-warpper">
          ...
          <div className="name-score">{userInfo?.coin?.toLocaleString()}&nbsp;COIN</div>
        </div>
      </div>
      <div className="right">
        {
  ...
  function ListItem({ username, coin, rank }: { username: string, coin: number, rank: number }) {
    return <div className="holders-item">
      <div className="holders-left">
        ...
        <div className="name-score-wrapper">
          ...
          <div className="name-score">{coin.toLocaleString()}&nbsp;COIN</div>
        </div>
      </div>
      <div className="right">
        {
