...
function LanguagePage() {
  ...
  const initData = async () => {
    ...
    let lang = localStorage.getItem('lang') || initData?.user?.languageCode
    if (lang = 'zh-hans') {
      lang = 'zh'
    }
    setLang(lang)
