...
function FrensPage() {
  ...
  return <div className='frens-page fadeIn'>
        ...
        <div className='rules-content'>
          <div className='rules-list'>
            ...
            <div className='rules-desc'>
              You will both get {systemConfig?.invite_coin}
              &nbsp;<img src="/assets/common/coin.png" alt="unit" />
              &nbsp;and {systemConfig?.invite_ticket}
              &nbsp;<img src="/assets/common/ticket.png" alt="unit" />.
            </div>
          </div>
          <div className='rules-list'>
            <div className='rules-list-title'>Invite a Friends with a Telegram Premium Account</div>
            <div className='rules-desc'>
              You will both get {systemConfig?.invite_coin_hy}
              &nbsp;<img src="/assets/common/coin.png" alt="unit" />
              &nbsp;and {systemConfig?.invite_ticket_hy}
              &nbsp;<img src="/assets/common/ticket.png" alt="unit" />.
            </div>
          </div>
          <div className='rules-list'>
    ...
    <div className='page-bottom'>
      <Button color="default" style={{ fontWeight: 'bold', height: '50px', borderRadius: '100px', flex: 1, background: 'var(--btnBg)', color: '#000', border: 'none' }} onClick={() => handleShare()}>👆🏻 Invite a fren</Button>
